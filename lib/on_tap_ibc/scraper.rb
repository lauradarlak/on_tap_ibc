...
class OnTapIbc::Scraper
  ...
  def self.scrape_detail_pages
    detail_pages = ["https:///www.ithacabeer.com/ithaca-beer-core-beliefs", "https://www.ithacabeer.com/ithaca-beer-random-acts"].each do |url|
      ...
      beers.css("div.col.sqs-col-10.span-10").each do |beer|
        ...
        beer_hash[:name][:long_desc] = beer.css("div.html-block p")[0].text.strip
